...
class AuthController extends Controller
{
    ...
    public function proses_login(Request $request)
    {
        ...
        // ambil data request username & password aja
        ...
        if (Auth::attempt($credential)) {
            ...
            // cel lagi jika level user admin maka arahkan ke halaman admin
            if ($user->level_id == '1') {
                //dd($user->level_id);
                return redirect()->intended('admin');
            }
    ...
    public function proses_register(Request $request)
    {
        ...
        // kalau berhasil ini level & hash passwordnya ya biar secure
        $request['level_id'] = '2';
